...
# PART 2
# Now each passport must have its credential values validated, still ignoring ['cid'] - rules at bottom of file

def isValid(pass_dict):
    eye_cols = ['amb', 'blu', 'brn', 'gry', 'grn', 'hzl', 'oth']
    
    height_val = pass_dict['hgt'] # get the height value to make comparison easier in the final check
